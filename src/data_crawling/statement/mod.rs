...
mod test {
    ...
    fn extract_cashflow_statement_data() {
        ...
        // Assert
        assert_snapshot!(result.get_column_names().join(", "), @"배출부채전입액, 차입금의증가, 연결범위변동으로인한현금의증가, 대손충당금환입액, 기타수익, 법인세비용차감전계속사업이익, 매출채권처분이익, 기타금융부채의증가, 기타재무활동으로인한현금흐름, 대손상각비, 무형자산상각비, 유형자산의증가, 퇴직급여, 금융자산손상차손, 배출부채환입액, 충당부채환입액, 자산처분(폐기)이익, 관계기업등지분관련투자자산의감소, 종업원급여, 장기대여금의증가, 주식매입선택권의행사, 이자수입, 사채의감소, 현금및현금성자산의증가, 유상증자, 금융부채관련이익, 사채상환이익, 파생상품손실, 영업활동으로인한자산부채변동(운전자본변동), 유동금융자산의감소, 현금유출이없는비용등가산, 생물자산의감소, 장기금융상품의증가, 법인세환입, 매도가능금융자산의증가, 기타재무활동으로인한현금유입액, 유상감자, 유동금융자산의증가, 만기보유금융자산의증가, 당기손익-공정가치측정 금융자산관련이익, (현금유입이없는수익등차감), 주식보상비환입, 재고자산폐기(처분)이익, 퇴직급여충당부채환입액, 금융자산처분이익, 기말현금및현금성자산, 자본구성항목의감소, 감가상각비, 기타부채의감소, 파생상품의변동, 기타운전자본의변동, 투자부동산의감소, 재고자산폐기(처분)손실, 차입금의감소, 사채의증가, 계약부채전입액, 주식보상비, 자기주식의처분, 환율변동효과, 이자지급(-), 기타금융부채의감소, 지분법관련손실, 장기대여금의감소, (재무활동으로인한현금유출액), 계약부채환입액, 부채의증가(감소), 무형자산의감소, 미지급금의증가, 기타비유동금융자산의증가, 배당금지급(-), 반품(환불)부채전입액, 금융부채관련손실, 무형자산의증가, 자산손상차손환입, 지분법관련이익, 종속회사관련이익, 기타영업활동으로인한현금흐름, 영업활동으로인한현금흐름, 파생상품이익, 배당금수입, 투자자산평가이익, 금융자산평가이익, 유동성장기부채의감소, 사채상환손실, 당기손익-공정가치측정 금융자산관련손실, 재고자산감모손실환입, 재고자산감모손실, 자산재평가손실, 법인세수익, 기타투자활동으로인한현금흐름, 자본구성항목의증가, 자산재평가이익, *영업에서창출된현금흐름, 반품(환불)부채환입액, 배당금지급, 금융자산평가손실, 투자활동으로인한현금흐름, 유형자산의감소, 유동성장기부채의증가, 기타부채의증가, 투자활동으로인한현금유입액, 배당금수익, 법인세납부(-), 생물자산의증가, 기타투자활동으로인한현금유입액, 이자비용, 미지급금의감소, 매출채권처분손실, (투자활동으로인한현금유출액), 이자수익, 충당부채전입액, 재무활동으로인한현금유입액, 금융원가, 투자부동산의증가, 기타비용, 금융수익, 자기주식의취득, 법인세비용, 자산의감소(증가), 매도가능금융자산의감소, 자산처분(폐기)손실, 정부보조금등의변동, 당기순손익, 기타의대손상각비, 종속기업관련손실, 관계기업관련손익, 외환이익, 장기금융상품의감소, 외환손실, 만기보유금융자산의감소, 기초현금및현금성자산, 영업투자재무활동기타현금흐름, 기타투자활동으로인한현금유출액, 중단영업관련현금흐름, 재무활동으로인한현금흐름, 금융자산손상차손환입, 기타비유동금융자산의감소, 금융자산처분손실, 기타재무활동으로인한현금유출액, 관계기업등지분관련투자자산의증가, 자산손상차손, 투자자산평가손실, 연도");
    }
    ...
    fn extract_comprehensive_income_statement_data() {
        ...
        let result = get_statement_table(input).unwrap();
        // Assert
        assert_snapshot!(result.get_column_names().join(", "), @"광고선전비, 자산손상차손, 종속기업,공동지배기업및관계기업투자주식손상관련손익, 지배주주순이익, 금융자산처분이익, 재고자산폐기(처분)이익, 금융수익, 파생상품이익, 기타금융수익, 당기손익-공정가치측정 금융자산평가이익, 임대료수익, 매출채권처분이익, 기타비용, 배당금수익, 세전계속사업이익, 기타금융원가, 충당부채환입액, 자산처분(폐기)이익, 법인세비용, 비지배주주순이익, 자산처분(폐기)손실, 외환이익, 금융자산처분손실, 중단영업이익, 이자비용, 당기순이익, 자산평가이익, 영업이익(발표기준), 대손충당금환입액, 기타수익, 종속기업,공동지배기업및관계기업투자주식처분손익, 로열티수익, 파생상품손실, 이자수익, 자산평가손실, 지분법손익, 매출액, 판매비와관리비, 외환손실, 기타원가성비용, 영업이익, 금융자산손상차손환입, 대손충당금환입, 당기손익-공정가치측정 금융자산관련손실, 충당부채전입액, 금융자산평가손실, 기타대손상각비, 금융자산평가이익, 당기손익-공정가치측정 금융자산관련이익, 계속영업이익, 매출총이익, 기타, 매출원가, 판매비, 재고자산감모손실환입, 매출채권처분손실, 수수료수익, 자산손상차손환입, 금융원가, 인건비, 당기손익-공정가치측정 금융자산평가손실, 재고자산감모손실, 금융자산손상차손, 연구개발비, 관리비, 대손상각비, 종속기업,공동지배기업및관계기업관련손익, 유무형자산상각비, 재고자산폐기(처분)손실, 연도");
    }
    ...
    fn extract_financial_position_statement_data() {
        ...
        let result = get_statement_table(input).unwrap();
        // Assert
        assert_snapshot!(result.get_column_names().join(", "), @"비유동종업원급여충당부채, 유동금융자산, 투자부동산, 단기사채, 장기매입채무및기타비유동채무, 이익잉여금(결손금), 이연법인세자산, 자산, 장기당기법인세자산, 기타금융업부채, 매각예정비유동자산및처분자산집단, 단기차입금, 유동성장기부채, 비지배주주지분, 유동금융부채, 반품(환불)부채, 기타포괄손익누계액, 매입채무및기타유동채무, 무형자산, 유동생물자산, 현금및현금성자산, 관계기업등지분관련투자자산, 유동종업원급여충당부채, 기타비유동자산, 기타단기충당부채, 계약부채, 기타유동부채, 매각예정으로분류된처분자산집단에포함된부채, 자본금, 자본, 당기법인세부채, 비유동자산, 지배기업주주지분, 기타비유동부채, 장기금융자산, 비유동생물자산, 기타장기충당부채, 기타유동자산, 유형자산, 자본잉여금, 비유동금융부채, 기타금융업자산, 계약자산, 배출부채, 이연법인세부채, 장기당기법인세부채, 유동부채, 신종자본증권, 부채, 재고자산, 배출권, 비유동부채, 반품(환불)자산, 사채, 유동자산, 매출채권및기타유동채권, 기타자본, 당기법인세자산, 장기차입금, 장기매출채권및기타비유동채권, 연도");
    }
