...
mod test {
    ...
    fn extract_cashflow_statement_data() {
        ...
        // Assert
        assert_snapshot!(result.get_column_names().join(", "), @"배출부채전입액, 종속기업관련손실, 사채상환이익, 미지급금의증가, 대손충당금환입액, 배당금수익, 장기금융상품의감소, 차입금의증가, 환율변동효과, 이자비용, 금융부채관련손실, *영업에서창출된현금흐름, 연결범위변동으로인한현금의증가, 무형자산의증가, 파생상품의변동, 계약부채환입액, 재무활동으로인한현금유입액, 투자자산평가손실, 주식보상비, 기타투자활동으로인한현금흐름, (현금유입이없는수익등차감), 유상증자, 자기주식의취득, 당기손익-공정가치측정 금융자산관련손실, 자산처분(폐기)손실, 현금유출이없는비용등가산, 자산재평가이익, 기초현금및현금성자산, 기타영업활동으로인한현금흐름, 배출부채환입액, 계약부채전입액, 유동성장기부채의감소, 영업투자재무활동기타현금흐름, 법인세수익, 생물자산의감소, 이자수입, 금융수익, 투자활동으로인한현금흐름, 법인세환입, 기타재무활동으로인한현금유입액, 법인세비용, 투자자산평가이익, 영업활동으로인한현금흐름, 배당금지급(-), 차입금의감소, 기타부채의감소, 파생상품이익, 매도가능금융자산의감소, 반품(환불)부채전입액, 기타수익, 생물자산의증가, 만기보유금융자산의증가, 매도가능금융자산의증가, 주식매입선택권의행사, 배당금수입, 기타금융부채의감소, 유상감자, 외환이익, 외환손실, 투자활동으로인한현금유입액, 지분법관련손실, 기타비유동금융자산의증가, 관계기업등지분관련투자자산의증가, 영업활동으로인한자산부채변동(운전자본변동), 기타비용, 매출채권처분이익, 금융부채관련이익, 퇴직급여충당부채환입액, 기타금융부채의증가, 사채상환손실, 종업원급여, 금융자산손상차손, 법인세납부(-), 자본구성항목의감소, 기타투자활동으로인한현금유출액, 유형자산의증가, 사채의증가, 금융자산처분이익, 기타의대손상각비, 미지급금의감소, 자산손상차손환입, 이자지급(-), 자산재평가손실, 금융자산손상차손환입, 관계기업관련손익, 자산의감소(증가), 장기금융상품의증가, 충당부채전입액, 투자부동산의증가, 유동금융자산의증가, 기타투자활동으로인한현금유입액, 만기보유금융자산의감소, (재무활동으로인한현금유출액), 종속회사관련이익, 무형자산상각비, 반품(환불)부채환입액, 금융원가, 유동금융자산의감소, 기타재무활동으로인한현금흐름, 유형자산의감소, 자산손상차손, 정부보조금등의변동, 재고자산폐기(처분)이익, 퇴직급여, 중단영업관련현금흐름, 지분법관련이익, 감가상각비, 파생상품손실, 주식보상비환입, 장기대여금의증가, 배당금지급, 장기대여금의감소, 투자부동산의감소, 금융자산평가손실, 부채의증가(감소), 기타비유동금융자산의감소, 금융자산평가이익, 재무활동으로인한현금흐름, 재고자산감모손실환입, 사채의감소, 당기순손익, 기타운전자본의변동, 자본구성항목의증가, 기타재무활동으로인한현금유출액, 기타부채의증가, 이자수익, 무형자산의감소, 유동성장기부채의증가, 충당부채환입액, 자기주식의처분, 대손상각비, 금융자산처분손실, 재고자산감모손실, (투자활동으로인한현금유출액), 현금및현금성자산의증가, 재고자산폐기(처분)손실, 자산처분(폐기)이익, 법인세비용차감전계속사업이익, 관계기업등지분관련투자자산의감소, 매출채권처분손실, 기말현금및현금성자산, 당기손익-공정가치측정 금융자산관련이익, 연도");
    }
    ...
    fn extract_comprehensive_income_statement_data() {
        ...
        let result = get_statement_table(input).unwrap();
        // Assert
        assert_snapshot!(result.get_column_names().join(", "), @"연구개발비, 충당부채전입액, 금융자산처분손실, 기타비용, 판매비와관리비, 외환손실, 유무형자산상각비, 자산평가이익, 배당금수익, 자산처분(폐기)손실, 수수료수익, 종속기업,공동지배기업및관계기업관련손익, 대손충당금환입액, 광고선전비, 영업이익, 파생상품손실, 법인세비용, 이자비용, 기타원가성비용, 당기순이익, 금융자산손상차손, 자산손상차손환입, 인건비, 금융원가, 당기손익-공정가치측정 금융자산평가이익, 당기손익-공정가치측정 금융자산관련손실, 재고자산폐기(처분)손실, 금융수익, 충당부채환입액, 외환이익, 대손상각비, 기타금융원가, 비지배주주순이익, 매출원가, 이자수익, 매출액, 기타수익, 관리비, 파생상품이익, 지분법손익, 기타대손상각비, 매출채권처분손실, 지배주주순이익, 금융자산처분이익, 판매비, 자산평가손실, 당기손익-공정가치측정 금융자산관련이익, 금융자산평가손실, 중단영업이익, 기타금융수익, 기타, 로열티수익, 재고자산감모손실, 영업이익(발표기준), 매출채권처분이익, 금융자산평가이익, 금융자산손상차손환입, 임대료수익, 당기손익-공정가치측정 금융자산평가손실, 세전계속사업이익, 종속기업,공동지배기업및관계기업투자주식처분손익, 계속영업이익, 자산손상차손, 재고자산감모손실환입, 자산처분(폐기)이익, 종속기업,공동지배기업및관계기업투자주식손상관련손익, 매출총이익, 대손충당금환입, 재고자산폐기(처분)이익, 연도");
    }
    ...
    fn extract_financial_position_statement_data() {
        ...
        let result = get_statement_table(input).unwrap();
        // Assert
        assert_snapshot!(result.get_column_names().join(", "), @"반품(환불)자산, 유동금융부채, 비지배주주지분, 단기차입금, 비유동자산, 기타장기충당부채, 단기사채, 기타금융업부채, 신종자본증권, 유동자산, 장기매입채무및기타비유동채무, 매입채무및기타유동채무, 이연법인세자산, 유동종업원급여충당부채, 배출권, 기타유동부채, 무형자산, 기타비유동부채, 자본금, 자본, 관계기업등지분관련투자자산, 재고자산, 자본잉여금, 매출채권및기타유동채권, 계약부채, 반품(환불)부채, 투자부동산, 사채, 부채, 자산, 장기당기법인세부채, 기타금융업자산, 비유동생물자산, 매각예정비유동자산및처분자산집단, 비유동종업원급여충당부채, 매각예정으로분류된처분자산집단에포함된부채, 현금및현금성자산, 장기매출채권및기타비유동채권, 장기금융자산, 유동생물자산, 배출부채, 기타포괄손익누계액, 유동부채, 비유동금융부채, 비유동부채, 기타자본, 이연법인세부채, 계약자산, 기타유동자산, 지배기업주주지분, 당기법인세자산, 장기차입금, 기타비유동자산, 유동성장기부채, 기타단기충당부채, 당기법인세부채, 이익잉여금(결손금), 유형자산, 장기당기법인세자산, 유동금융자산, 연도");
    }
