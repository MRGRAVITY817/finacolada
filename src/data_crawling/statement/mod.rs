...
mod test {
    ...
    fn extract_cashflow_statement_data() {
        ...
        // Assert
        assert_snapshot!(result.get_column_names().join(", "), @"금융수익, 기타비유동금융자산의증가, 계약부채전입액, 관계기업등지분관련투자자산의감소, 자기주식의처분, 영업활동으로인한자산부채변동(운전자본변동), 유형자산의증가, 자본구성항목의증가, 금융자산손상차손환입, 금융자산평가이익, 외환손실, 투자부동산의증가, 충당부채전입액, 기타비용, 사채의증가, 투자자산평가손실, 영업활동으로인한현금흐름, 재고자산폐기(처분)이익, 장기대여금의증가, 계약부채환입액, 매도가능금융자산의증가, 기타금융부채의증가, 유동금융자산의감소, 기타금융부채의감소, 유상감자, 현금유출이없는비용등가산, 주식보상비환입, 법인세환입, 투자부동산의감소, 장기대여금의감소, 지분법관련이익, 생물자산의증가, 충당부채환입액, 만기보유금융자산의증가, 기타투자활동으로인한현금유입액, 기타운전자본의변동, 반품(환불)부채환입액, 투자활동으로인한현금흐름, 종업원급여, 무형자산상각비, 사채의감소, 기말현금및현금성자산, 법인세수익, 매출채권처분손실, 장기금융상품의감소, 기타비유동금융자산의감소, 주식보상비, 자본구성항목의감소, 이자비용, 기타수익, 법인세납부(-), 중단영업관련현금흐름, 영업투자재무활동기타현금흐름, 파생상품손실, 기타영업활동으로인한현금흐름, 기타투자활동으로인한현금유출액, 자산재평가손실, 종속기업관련손실, 배당금수입, 퇴직급여, (재무활동으로인한현금유출액), 법인세비용, 법인세비용차감전계속사업이익, 배출부채전입액, 재고자산폐기(처분)손실, 자산처분(폐기)이익, 금융부채관련손실, 금융자산처분이익, 배당금지급(-), 매출채권처분이익, 감가상각비, 금융자산평가손실, 기타부채의감소, 사채상환손실, 재고자산감모손실환입, 자산재평가이익, 기타투자활동으로인한현금흐름, 배당금지급, 이자수익, 관계기업등지분관련투자자산의증가, 지분법관련손실, 기타재무활동으로인한현금흐름, 종속회사관련이익, 만기보유금융자산의감소, 현금및현금성자산의증가, 유형자산의감소, 금융부채관련이익, 주식매입선택권의행사, 정부보조금등의변동, 부채의증가(감소), 미지급금의증가, 투자활동으로인한현금유입액, 당기순손익, 환율변동효과, 기타의대손상각비, 미지급금의감소, 유동금융자산의증가, 매도가능금융자산의감소, 배출부채환입액, 퇴직급여충당부채환입액, 자산손상차손환입, (현금유입이없는수익등차감), 장기금융상품의증가, 유상증자, 유동성장기부채의감소, 사채상환이익, 파생상품의변동, 반품(환불)부채전입액, (투자활동으로인한현금유출액), 외환이익, 대손상각비, 당기손익-공정가치측정 금융자산관련이익, 기초현금및현금성자산, *영업에서창출된현금흐름, 금융자산손상차손, 유동성장기부채의증가, 자산손상차손, 기타부채의증가, 금융자산처분손실, 무형자산의감소, 관계기업관련손익, 기타재무활동으로인한현금유입액, 대손충당금환입액, 기타재무활동으로인한현금유출액, 자산처분(폐기)손실, 자기주식의취득, 당기손익-공정가치측정 금융자산관련손실, 무형자산의증가, 이자수입, 투자자산평가이익, 이자지급(-), 배당금수익, 재무활동으로인한현금유입액, 재고자산감모손실, 차입금의증가, 차입금의감소, 연결범위변동으로인한현금의증가, 생물자산의감소, 금융원가, 파생상품이익, 자산의감소(증가), 재무활동으로인한현금흐름, 연도");
    }
    ...
    fn extract_comprehensive_income_statement_data() {
        ...
        let result = get_statement_table(input).unwrap();
        // Assert
        assert_snapshot!(result.get_column_names().join(", "), @"자산손상차손, 외환이익, 충당부채전입액, 기타, 외환손실, 당기손익-공정가치측정 금융자산관련이익, 매출채권처분이익, 재고자산감모손실환입, 기타대손상각비, 계속영업이익, 매출채권처분손실, 파생상품이익, 재고자산폐기(처분)손실, 자산처분(폐기)이익, 금융원가, 비지배주주순이익, 기타금융원가, 자산평가이익, 임대료수익, 충당부채환입액, 기타비용, 광고선전비, 연구개발비, 금융자산처분손실, 금융자산손상차손환입, 종속기업,공동지배기업및관계기업투자주식손상관련손익, 판매비와관리비, 매출액, 대손충당금환입액, 당기손익-공정가치측정 금융자산평가손실, 금융수익, 재고자산감모손실, 영업이익(발표기준), 세전계속사업이익, 재고자산폐기(처분)이익, 파생상품손실, 종속기업,공동지배기업및관계기업관련손익, 유무형자산상각비, 매출원가, 기타수익, 대손상각비, 인건비, 자산손상차손환입, 수수료수익, 관리비, 자산처분(폐기)손실, 금융자산처분이익, 금융자산손상차손, 자산평가손실, 중단영업이익, 영업이익, 판매비, 이자비용, 지분법손익, 당기순이익, 지배주주순이익, 종속기업,공동지배기업및관계기업투자주식처분손익, 당기손익-공정가치측정 금융자산평가이익, 금융자산평가이익, 당기손익-공정가치측정 금융자산관련손실, 대손충당금환입, 금융자산평가손실, 로열티수익, 이자수익, 매출총이익, 배당금수익, 법인세비용, 기타금융수익, 기타원가성비용, 연도");
    }
    ...
    fn extract_financial_position_statement_data() {
        ...
        let result = get_statement_table(input).unwrap();
        // Assert
        assert_snapshot!(result.get_column_names().join(", "), @"매각예정비유동자산및처분자산집단, 장기차입금, 재고자산, 배출부채, 비유동자산, 비유동금융부채, 자본금, 자본, 비유동종업원급여충당부채, 사채, 매각예정으로분류된처분자산집단에포함된부채, 기타유동자산, 이연법인세자산, 장기당기법인세자산, 비지배주주지분, 유동자산, 유동금융자산, 당기법인세자산, 유형자산, 기타금융업부채, 유동부채, 기타유동부채, 기타장기충당부채, 기타포괄손익누계액, 장기금융자산, 매출채권및기타유동채권, 투자부동산, 기타비유동부채, 장기매입채무및기타비유동채무, 단기차입금, 반품(환불)부채, 비유동생물자산, 비유동부채, 유동종업원급여충당부채, 배출권, 계약부채, 기타금융업자산, 매입채무및기타유동채무, 지배기업주주지분, 당기법인세부채, 유동성장기부채, 장기당기법인세부채, 현금및현금성자산, 무형자산, 기타단기충당부채, 장기매출채권및기타비유동채권, 부채, 관계기업등지분관련투자자산, 반품(환불)자산, 이연법인세부채, 자본잉여금, 계약자산, 자산, 유동생물자산, 신종자본증권, 이익잉여금(결손금), 기타비유동자산, 유동금융부채, 단기사채, 기타자본, 연도");
    }
