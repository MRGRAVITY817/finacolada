...
mod test {
    ...
    fn extract_cashflow_statement_data() {
        ...
        // Assert
        assert_snapshot!(result.get_column_names().join(", "), @"금융수익, 기타부채의감소, 유상감자, 자산처분(폐기)손실, 자기주식의취득, 지분법관련손실, 유동금융자산의감소, 기타수익, 만기보유금융자산의감소, 금융자산손상차손환입, 연결범위변동으로인한현금의증가, 기타금융부채의감소, 퇴직급여충당부채환입액, 당기순손익, 현금및현금성자산의증가, 투자자산평가이익, 기타투자활동으로인한현금유출액, 종속회사관련이익, 기타운전자본의변동, 기말현금및현금성자산, 무형자산상각비, 자산처분(폐기)이익, 파생상품의변동, 관계기업등지분관련투자자산의증가, 장기금융상품의감소, 금융부채관련손실, 기타비용, 자기주식의처분, 외환손실, 투자부동산의감소, 기타투자활동으로인한현금흐름, 이자비용, 자산의감소(증가), 부채의증가(감소), 배당금지급(-), 주식매입선택권의행사, 기타의대손상각비, 기타비유동금융자산의증가, 금융자산처분이익, 기타재무활동으로인한현금흐름, 충당부채전입액, 배당금지급, 파생상품손실, 자산재평가이익, 중단영업관련현금흐름, 장기대여금의감소, 환율변동효과, 외환이익, 재고자산폐기(처분)손실, 법인세비용, 금융자산손상차손, 충당부채환입액, 퇴직급여, 배출부채환입액, 재고자산폐기(처분)이익, 기타영업활동으로인한현금흐름, 자산손상차손, (투자활동으로인한현금유출액), 매출채권처분이익, 미지급금의증가, 재무활동으로인한현금유입액, 투자부동산의증가, 금융자산처분손실, 재고자산감모손실, 기타부채의증가, 감가상각비, 파생상품이익, 대손충당금환입액, 영업활동으로인한자산부채변동(운전자본변동), 만기보유금융자산의증가, 투자활동으로인한현금흐름, 차입금의감소, 지분법관련이익, 매출채권처분손실, 사채상환이익, 미지급금의감소, 유동성장기부채의감소, 주식보상비, 이자수익, 기타재무활동으로인한현금유출액, 영업투자재무활동기타현금흐름, (재무활동으로인한현금유출액), 이자지급(-), 자본구성항목의증가, 생물자산의감소, 주식보상비환입, 종속기업관련손실, 투자자산평가손실, 이자수입, 생물자산의증가, 기타재무활동으로인한현금유입액, 자산재평가손실, 반품(환불)부채환입액, 배당금수입, 금융자산평가이익, 법인세수익, 기타투자활동으로인한현금유입액, 유형자산의증가, 유상증자, 장기대여금의증가, 종업원급여, 유형자산의감소, 자본구성항목의감소, 기초현금및현금성자산, 정부보조금등의변동, 유동성장기부채의증가, 무형자산의증가, 자산손상차손환입, 금융원가, 계약부채전입액, 현금유출이없는비용등가산, 금융자산평가손실, 관계기업관련손익, 차입금의증가, 대손상각비, 기타비유동금융자산의감소, 매도가능금융자산의감소, 무형자산의감소, 배당금수익, 반품(환불)부채전입액, 관계기업등지분관련투자자산의감소, *영업에서창출된현금흐름, 법인세납부(-), 유동금융자산의증가, 사채상환손실, 장기금융상품의증가, 금융부채관련이익, 당기손익-공정가치측정 금융자산관련이익, 투자활동으로인한현금유입액, 당기손익-공정가치측정 금융자산관련손실, (현금유입이없는수익등차감), 배출부채전입액, 기타금융부채의증가, 재고자산감모손실환입, 매도가능금융자산의증가, 사채의감소, 재무활동으로인한현금흐름, 영업활동으로인한현금흐름, 사채의증가, 법인세환입, 계약부채환입액, 법인세비용차감전계속사업이익, 연도");
    }
    ...
    fn extract_comprehensive_income_statement_data() {
        ...
        let result = get_statement_table(input).unwrap();
        // Assert
        assert_snapshot!(result.get_column_names().join(", "), @"외환이익, 지분법손익, 금융자산처분이익, 자산평가손실, 금융자산평가이익, 기타금융수익, 임대료수익, 금융수익, 기타대손상각비, 이자비용, 이자수익, 관리비, 파생상품이익, 매출액, 외환손실, 기타수익, 인건비, 당기손익-공정가치측정 금융자산평가이익, 당기순이익, 금융자산평가손실, 종속기업,공동지배기업및관계기업투자주식처분손익, 중단영업이익, 연구개발비, 광고선전비, 대손충당금환입액, 충당부채전입액, 재고자산감모손실, 기타금융원가, 재고자산폐기(처분)이익, 당기손익-공정가치측정 금융자산관련손실, 충당부채환입액, 매출채권처분손실, 자산처분(폐기)이익, 당기손익-공정가치측정 금융자산평가손실, 수수료수익, 대손충당금환입, 금융자산손상차손환입, 법인세비용, 파생상품손실, 자산손상차손환입, 자산평가이익, 영업이익, 배당금수익, 대손상각비, 금융자산손상차손, 재고자산폐기(처분)손실, 세전계속사업이익, 종속기업,공동지배기업및관계기업관련손익, 판매비, 유무형자산상각비, 자산처분(폐기)손실, 로열티수익, 당기손익-공정가치측정 금융자산관련이익, 영업이익(발표기준), 비지배주주순이익, 금융원가, 매출채권처분이익, 재고자산감모손실환입, 자산손상차손, 계속영업이익, 기타, 지배주주순이익, 매출원가, 종속기업,공동지배기업및관계기업투자주식손상관련손익, 매출총이익, 기타원가성비용, 판매비와관리비, 기타비용, 금융자산처분손실, 연도");
    }
    ...
    fn extract_financial_position_statement_data() {
        ...
        let result = get_statement_table(input).unwrap();
        // Assert
        assert_snapshot!(result.get_column_names().join(", "), @"유동성장기부채, 비유동종업원급여충당부채, 당기법인세자산, 배출권, 반품(환불)부채, 비지배주주지분, 계약자산, 비유동부채, 사채, 기타비유동부채, 장기매입채무및기타비유동채무, 기타포괄손익누계액, 자산, 투자부동산, 유동자산, 기타금융업자산, 단기사채, 배출부채, 비유동금융부채, 비유동자산, 기타금융업부채, 기타유동부채, 계약부채, 매입채무및기타유동채무, 부채, 이연법인세부채, 유동금융자산, 현금및현금성자산, 이익잉여금(결손금), 기타단기충당부채, 기타장기충당부채, 신종자본증권, 자본, 재고자산, 매출채권및기타유동채권, 유형자산, 기타자본, 유동부채, 지배기업주주지분, 장기금융자산, 유동종업원급여충당부채, 자본금, 매각예정비유동자산및처분자산집단, 단기차입금, 반품(환불)자산, 장기매출채권및기타비유동채권, 장기당기법인세자산, 당기법인세부채, 장기차입금, 장기당기법인세부채, 기타유동자산, 유동금융부채, 유동생물자산, 이연법인세자산, 관계기업등지분관련투자자산, 매각예정으로분류된처분자산집단에포함된부채, 자본잉여금, 무형자산, 기타비유동자산, 비유동생물자산, 연도");
    }
