...
mod test {
    ...
    fn extract_cashflow_statement_data() {
        ...
        // Assert
        assert_snapshot!(result.get_column_names().join(", "), @"배출부채전입액, 퇴직급여, 기타재무활동으로인한현금흐름, 금융자산손상차손환입, 현금유출이없는비용등가산, 계약부채전입액, 만기보유금융자산의감소, 기타금융부채의증가, 법인세수익, 기타영업활동으로인한현금흐름, 자산의감소(증가), 투자활동으로인한현금유입액, 투자자산평가이익, 충당부채전입액, 환율변동효과, 유동성장기부채의증가, 기초현금및현금성자산, 매도가능금융자산의증가, 감가상각비, 재무활동으로인한현금흐름, 반품(환불)부채전입액, 법인세비용차감전계속사업이익, 자본구성항목의증가, 연결범위변동으로인한현금의증가, 자산처분(폐기)손실, 배당금수익, 만기보유금융자산의증가, 주식보상비, 종속기업관련손실, 재무활동으로인한현금유입액, 금융자산처분손실, 금융수익, 차입금의증가, 금융자산처분이익, 반품(환불)부채환입액, 이자비용, 법인세비용, 자산처분(폐기)이익, 배당금지급(-), 투자활동으로인한현금흐름, 무형자산상각비, 금융자산평가손실, 장기대여금의증가, 주식매입선택권의행사, 유상감자, 기타재무활동으로인한현금유출액, 영업투자재무활동기타현금흐름, *영업에서창출된현금흐름, 사채상환이익, 자산손상차손환입, 무형자산의감소, 법인세환입, 자기주식의처분, 금융부채관련이익, 금융부채관련손실, 대손상각비, 파생상품손실, 사채의감소, 매출채권처분이익, 자본구성항목의감소, 관계기업등지분관련투자자산의감소, 유동금융자산의감소, 정부보조금등의변동, 관계기업등지분관련투자자산의증가, 생물자산의증가, 지분법관련손실, 자기주식의취득, 현금및현금성자산의증가, 대손충당금환입액, 자산재평가이익, 유형자산의감소, 무형자산의증가, 종업원급여, 기타부채의증가, 자산손상차손, 영업활동으로인한자산부채변동(운전자본변동), 유상증자, 종속회사관련이익, 계약부채환입액, 기타비유동금융자산의증가, 영업활동으로인한현금흐름, 지분법관련이익, 기타투자활동으로인한현금유입액, 사채의증가, 기타재무활동으로인한현금유입액, 미지급금의감소, 매도가능금융자산의감소, 투자자산평가손실, 이자수익, 배출부채환입액, 자산재평가손실, 당기손익-공정가치측정 금융자산관련이익, 퇴직급여충당부채환입액, 파생상품의변동, 투자부동산의감소, 기타투자활동으로인한현금유출액, 기타투자활동으로인한현금흐름, 부채의증가(감소), 기타금융부채의감소, 기말현금및현금성자산, 유형자산의증가, 배당금수입, 유동금융자산의증가, 장기금융상품의증가, 이자지급(-), 금융자산손상차손, 사채상환손실, 재고자산감모손실, 이자수입, 재고자산폐기(처분)이익, (투자활동으로인한현금유출액), 장기대여금의감소, 생물자산의감소, 관계기업관련손익, 법인세납부(-), 재고자산감모손실환입, 장기금융상품의감소, 재고자산폐기(처분)손실, 매출채권처분손실, 외환손실, 외환이익, 충당부채환입액, 기타운전자본의변동, 기타비유동금융자산의감소, 당기순손익, 파생상품이익, 기타수익, 중단영업관련현금흐름, 기타부채의감소, 기타의대손상각비, 배당금지급, 투자부동산의증가, 차입금의감소, 주식보상비환입, 유동성장기부채의감소, 금융자산평가이익, 금융원가, (현금유입이없는수익등차감), 당기손익-공정가치측정 금융자산관련손실, 미지급금의증가, 기타비용, (재무활동으로인한현금유출액), 연도");
    }
    ...
    fn extract_comprehensive_income_statement_data() {
        ...
        let result = get_statement_table(input).unwrap();
        // Assert
        assert_snapshot!(result.get_column_names().join(", "), @"세전계속사업이익, 기타수익, 재고자산폐기(처분)이익, 기타비용, 파생상품이익, 대손충당금환입, 대손상각비, 판매비와관리비, 매출원가, 기타대손상각비, 영업이익(발표기준), 금융자산평가이익, 매출총이익, 금융자산손상차손환입, 금융자산평가손실, 수수료수익, 당기손익-공정가치측정 금융자산관련손실, 자산평가손실, 당기순이익, 자산평가이익, 영업이익, 배당금수익, 금융수익, 인건비, 금융자산처분손실, 자산손상차손, 매출채권처분이익, 재고자산감모손실환입, 종속기업,공동지배기업및관계기업관련손익, 기타, 로열티수익, 판매비, 지분법손익, 충당부채전입액, 매출채권처분손실, 금융자산처분이익, 대손충당금환입액, 계속영업이익, 비지배주주순이익, 지배주주순이익, 당기손익-공정가치측정 금융자산관련이익, 외환이익, 기타금융수익, 이자비용, 광고선전비, 자산처분(폐기)이익, 자산손상차손환입, 당기손익-공정가치측정 금융자산평가손실, 유무형자산상각비, 재고자산폐기(처분)손실, 종속기업,공동지배기업및관계기업투자주식처분손익, 연구개발비, 금융자산손상차손, 관리비, 이자수익, 금융원가, 외환손실, 당기손익-공정가치측정 금융자산평가이익, 기타원가성비용, 파생상품손실, 기타금융원가, 자산처분(폐기)손실, 종속기업,공동지배기업및관계기업투자주식손상관련손익, 법인세비용, 임대료수익, 중단영업이익, 매출액, 충당부채환입액, 재고자산감모손실, 연도");
    }
    ...
    fn extract_financial_position_statement_data() {
        ...
        let result = get_statement_table(input).unwrap();
        // Assert
        assert_snapshot!(result.get_column_names().join(", "), @"이연법인세부채, 계약부채, 매출채권및기타유동채권, 기타비유동부채, 기타비유동자산, 기타자본, 재고자산, 자본, 이연법인세자산, 당기법인세부채, 기타포괄손익누계액, 이익잉여금(결손금), 단기차입금, 비유동생물자산, 장기당기법인세자산, 배출권, 기타금융업자산, 유동성장기부채, 반품(환불)부채, 사채, 비유동종업원급여충당부채, 유형자산, 자본잉여금, 기타금융업부채, 유동종업원급여충당부채, 배출부채, 관계기업등지분관련투자자산, 지배기업주주지분, 장기당기법인세부채, 투자부동산, 비유동부채, 비유동자산, 부채, 당기법인세자산, 유동부채, 매입채무및기타유동채무, 무형자산, 기타단기충당부채, 유동금융자산, 자산, 매각예정비유동자산및처분자산집단, 장기매출채권및기타비유동채권, 매각예정으로분류된처분자산집단에포함된부채, 비지배주주지분, 기타유동부채, 계약자산, 비유동금융부채, 장기매입채무및기타비유동채무, 신종자본증권, 자본금, 기타유동자산, 기타장기충당부채, 단기사채, 장기금융자산, 유동자산, 장기차입금, 반품(환불)자산, 유동금융부채, 유동생물자산, 현금및현금성자산, 연도");
    }
