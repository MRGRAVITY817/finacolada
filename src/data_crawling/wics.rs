...
mod test {
    ...
    async fn can_read_wics_parquet_as_lazyframe() {
        ...
        shape: (10, 14)
        ┌────────┬──────────────┬───────────┬────────┬─────┬─────────────┬─────┬───────┬───────────┐
        │ idx_cd ┆ idx_nm_kor   ┆ all_mkt_v ┆ cmp_cd ┆ ... ┆ sec_nm_kor  ┆ seq ┆ top60 ┆ apt_shr_c │
        │ ---    ┆ ---          ┆ al        ┆ ---    ┆     ┆ ---         ┆ --- ┆ ---   ┆ nt        │
        │ str    ┆ str          ┆ ---       ┆ str    ┆     ┆ str         ┆ i32 ┆ u32   ┆ ---       │
        │        ┆              ┆ u64       ┆        ┆     ┆             ┆     ┆       ┆ u64       │
        ╞════════╪══════════════╪═══════════╪════════╪═════╪═════════════╪═════╪═══════╪═══════════╡
        │ G25    ┆ WICS 경기관  ┆ 127513928 ┆ 005380 ┆ ... ┆ 경기관련소  ┆ 1   ┆ 9     ┆ 141021003 │
        │        ┆ 련소비재     ┆           ┆        ┆     ┆ 비재        ┆     ┆       ┆           │
        ├╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌┼╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌┼╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌┤
        │ G35    ┆ WICS         ┆ 106729517 ┆ 068270 ┆ ... ┆ 건강관리    ┆ 1   ┆ 25    ┆ 111200858 │
        │        ┆ 건강관리     ┆           ┆        ┆     ┆             ┆     ┆       ┆           │
        ├╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌┼╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌┼╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌┤
        │ G50    ┆ WICS 커뮤니  ┆ 107864411 ┆ 035420 ┆ ... ┆ 커뮤니케이  ┆ 1   ┆ 6     ┆ 127958286 │
        │        ┆ 케이션서비스 ┆           ┆        ┆     ┆ 션서비스    ┆     ┆       ┆           │
        ├╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌┼╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌┼╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌┤
        ...
        │ ...    ┆ ...          ┆ ...       ┆ ...    ┆ ... ┆ ...         ┆ ... ┆ ...   ┆ ...       │
        ├╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌┼╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌┼╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌┤
        │ G55    ┆ WICS         ┆ 11624366  ┆ 015760 ┆ ... ┆ 유틸리티    ┆ 1   ┆ 2     ┆ 288883835 │
        │        ┆ 유틸리티     ┆           ┆        ┆     ┆             ┆     ┆       ┆           │
        ├╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌┼╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌┼╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌┤
        │ G30    ┆ WICS         ┆ 28918599  ┆ 033780 ┆ ... ┆ 필수소비재  ┆ 1   ┆ 5     ┆ 108461073 │
        │        ┆ 필수소비재   ┆           ┆        ┆     ┆             ┆     ┆       ┆           │
        ├╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌┼╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌┼╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌┤
        │ G15    ┆ WICS 소재    ┆ 112616619 ┆ 051910 ┆ ... ┆ 소재        ┆ 1   ┆ 6     ┆ 45179100  │
        ├╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌┼╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌╌╌┼╌╌╌╌╌┼╌╌╌╌╌╌╌┼╌╌╌╌╌╌╌╌╌╌╌┤
        │ G45    ┆ WICS IT      ┆ 513513422 ┆ 005930 ┆ ... ┆ IT          ┆ 1   ┆ 2     ┆ 447733691 │
        │        ┆              ┆           ┆        ┆     ┆             ┆     ┆       ┆ 3         │
        └────────┴──────────────┴───────────┴────────┴─────┴─────────────┴─────┴───────┴───────────┘
        "###)
    }
